#This function is in charge of the display and asking of the country questions
def cquestions():
  global correct
  correct = 0
  q = 0
  ...
  while q<10:
    ...
    #goes through the dictionary
        ...
        #converts the user's nswer to lowercase and strips any spaces before the answer
        if cq.get(key)==user_answer and user_answer in valid_ans:
            correct+=1
            q+=1
            print("Correct! You have ",correct,"out of",q,"correct so far.")
            print(border)
            break
        elif cq.get(key)!=user_answer and user_answer in valid_ans:
            q+=1
            print("Incorrect! You have ",correct,"out of",q,"correct so far.")
            print(border)
            
            break
        else:
  #If none of the inputs fall under the criteria it displays this message and displays the question again
            print("That is not one of the options. Try a,b,c or d.")

#This function is in charge of the display and asking of the sports questions
def squestions():
  global correct
  correct = 0
  q = 0
...
#This function is in charge of the displayand asking of the physics questions
def pquestions():
  global correct
  correct = 0
  q=0
...
#This function is in charge of asking the player if they want to play again
def play_again():
  while True:
...
#This function is in charge of asking the player if they want instructions to play
def intro():
  while True:
